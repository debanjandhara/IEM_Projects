...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Receiptt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt2.insert(END, 'IND ' + Receipt_Ref.get() + " WB\n")
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Santragachi":
                    switch ={"Park Circus": 10,"SECTOR V": 8,"Newtown":6,"Santragachi": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Park Circus":
                    switch ={"Park Circus": 0,"SECTOR V": 2,"Newtown":5,"Santragachi": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "SECTOR V":
                    switch ={"Park Circus": 2,"SECTOR V": 0,"Newtown":3,"Santragachi": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Newtown":
                    switch ={"Park Circus": 5,"SECTOR V": 3,"Newtown":0,"Santragachi": 6}
                    Km.set(switch[varl2.get()])        
        ...
        def Total_Paid():
            if ((var1.get() == 1 and var2.get() == 1 and var3.get() == 1 or var4.get() == 1) and carType.get() != 0 and journeyType.get() != 0 and (varl1.get() != "" and varl2.get() !="")):
                ...
                w = ms.showwarning("Error !","TRY AGAIN !!! Please Fill It Again \n Also, you must Select the Star Marked Fields")
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','Santragachi','Newtown','SECTOR V','Park Circus')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Park Circus','SECTOR V','Santragachi','Newtown')
        self.cboDrop.current(0)
    ...
    #==========================================================Cabselect=======================================================================
        ...
        self.chkStandard=Radiobutton(Book_Frame,text="Auto / e-Rickshaw",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        ...
        self.chkFordGalaxyd=Radiobutton(Book_Frame,text="Non AC - CAB",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        ...
        self.chkFordMondeo = Radiobutton(Book_Frame,text="AC - CAB",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0)
